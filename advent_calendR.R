...
background_images <- list(
    '1' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
    '2' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
    '3' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
    '4' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
    '5' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
    '6' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
    '7' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
    '8' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
    '9' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
    '10' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
    '11' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
    '12' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
    '13' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
    ...
    '21' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
    '22' = paste0(GITHUB_BASE_URL, "HP1.jpg"),
